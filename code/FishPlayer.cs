...
public sealed class FishPlayer : Component
{
	[Property]
	[Category("Components")]
	...
	private void Punch()
	{
		...
		var punchTrace = Scene.Trace.FromTo( EyeWorldPosition, EyeWorldPosition + EyeAngles.Forward * PunchRange )
			.Size( 10f )
			.WithoutTags( "player" )
		...
		if ( punchTrace.Hit )
		{
			if ( punchTrace.Component.Components.TryGet<UnitInfo>( out var unitInfo ) )
			{
